  ...
  return (
    <div className="rounded-lg border border-slate-200 p-5 odd:rotate-1 even:-rotate-1 dark:border-slate-800 dark:bg-linear-to-t dark:from-slate-800 dark:to-slate-800/30">
      ...
      <div className="mb-8 text-center">
        <div className="font-aspekta mb-1 font-[650]">Never miss an update!</div>
      ...
      <form>
        <div className="mb-2">
          ...
          <input id="newsletter" type="email" className="form-input w-full py-1" placeholder="Your email…" />
        </div>
        <button className="btn-sm w-full bg-sky-500 text-slate-100 hover:bg-sky-600" type="submit">
          Subscribe
        </button>
      </form>
    </div>
