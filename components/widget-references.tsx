...
export default function WidgetReferences() {
  return (
    <div className="rounded-lg border border-slate-200 p-5 odd:rotate-1 even:-rotate-1 dark:border-slate-800 dark:bg-linear-to-t dark:from-slate-800 dark:to-slate-800/30">
      <div className="font-aspekta mb-3 font-[650]">References</div>
      <ul className="space-y-3">
        <li>
          <a className="group flex items-center justify-between space-x-2" href="#0">
            <div className="flex grow items-center space-x-3 truncate">
              ...
              <div className="truncate">
                <div className="font-aspekta mb-1 truncate text-sm font-[650]">Mr. Mark Smularkov</div>
        ...
        <li>
          <a className="group flex items-center justify-between space-x-2" href="#0">
            <div className="flex grow items-center space-x-3 truncate">
              ...
              <div className="truncate">
                <div className="font-aspekta mb-1 truncate text-sm font-[650]">Jame Kulls</div>
