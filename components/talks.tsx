...
export default function Talks() {
  return (
    <section>
      <h2 className="font-aspekta mb-5 text-xl font-[650]">Popular Talks</h2>

      {/* Cards */}
      <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
        <a
          className="relative aspect-video overflow-hidden rounded-lg bg-linear-to-tr from-slate-800 to-slate-700 shadow-xl transition-transform duration-700 ease-in-out odd:rotate-1 even:-rotate-1 hover:rotate-0 hover:duration-100"
          href="#0"
        >
          <Image
          ...
          <div className="relative flex h-full flex-col items-start justify-between p-5 before:mt-auto before:flex-1">
            <div className="font-aspekta flex flex-1 items-center text-lg font-[650] text-white">
